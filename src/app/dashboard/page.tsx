  ...
  return (
    <Card className="flex-1 gap-0 p-4">
      ...
      <CardContent className="p-4 pt-5 flex flex-col items-center gap-4">
        ...
        <Button variant="outline" className=" justify-between text-sm bg-[#0D0D0D] text-white">
          Book Session
...
function RequestStatusCard({ status, count, description }: { status: string; count: number; description: string }) {
  const icon = status === 'Active' ? <RefreshCw size={14} className="text-[#A1A1A1]" /> :
               status === 'Pending' ? <ClockArrowDown size={14} className="text-[#A1A1A1]"/> :
    ...
    <Card className="flex-1 gap-0 p-4">
      <CardHeader className="p-0">
        <div className="flex justify-between items-center">
          ...
          <Button variant="ghost" size="sm" className="text-xs">Open Hub</Button>
        </div>
      </CardHeader>
  ...
  return (
    <Card className="flex-1 gap-0 p-4">
      ...
      <CardContent className="py-4 px-0">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-0">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" className="text-xs flex items-center gap-2 p-0 hover:bg-transparent text-[#424242]">
                Link
                <div className="border-[#D5D7DA] border rounded-sm p-1"><ExternalLink size={14} className="text-[#A1A1A1]" /></div>
              </Button>
            </div>
        ...
        <p className="text-xs text-[#A1A1A1] mt-4">You have no more scheduled consultations.</p>
      </CardContent>
    </Card>
  )
}
    ...
    <Card className="flex-1 gap-0 p-4">
      <CardHeader className="p-0">
        <div className="flex justify-between items-center">
          ...
          <Button variant="ghost" size="sm" className="border-[#D5D7DA] border rounded-sm !p-1"><ExternalLink size={12} className="text-[#A1A1A1]" /></Button>
        </div>
      </CardHeader>
      <CardContent>
        <GaugeChart value={87} />
        ...
        <table className="w-full">
          <thead>
            <tr className="text-left">
              <th className="py-2 px-4 text-xs text-[#A1A1A1] font-medium">Request</th>
              <th className="py-2 px-4 text-xs text-[#A1A1A1] font-medium">Date</th>
              <th className="py-2 px-4 text-xs text-[#A1A1A1] font-medium">Status</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="py-3 px-4 text-sm">Google Ads Review</td>
              <td className="py-3 px-4 text-xs text-[#A1A1A1]">Today, 2:15 pm</td>
            ...
            <tr>
              ...
              <td className="py-3 px-4 text-xs text-[#A1A1A1]">Yesterday, 4:22 pm</td>
              <td className="py-3 px-4">
                <div className="flex items-center gap-2">
            ...
            <tr>
              ...
              <td className="py-3 px-4 text-xs text-[#A1A1A1]">1 April, 10:00 am</td>
              <td className="py-3 px-4">
                <div className="flex items-center gap-2">
                  <FileCheck size={14}/>
      ...
      <div className="py-12 max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2 items-center">
            <Button variant="default" className="bg-[#0D0D0D] hover:bg-black/90 text-white">
              + New Support Request
            </Button>
